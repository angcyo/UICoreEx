package com.angcyo.github.biometric
 ...
 */
class BiometricAuthenticationException(val errorMessageId: Int, val errorString: CharSequence) :
    RuntimeException(errorString.toString())
 ...
 */
class BiometricAuthenticationCancelledException :
    RuntimeException("The Authentication has been cancelled")