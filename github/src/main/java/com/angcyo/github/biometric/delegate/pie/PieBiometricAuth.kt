package com.angcyo.github.biometric.delegate.pie
...
import com.angcyo.github.biometric.BiometricConstants
import com.angcyo.github.biometric.delegate.AuthenticationEvent
import io.reactivex.*
import java.util.concurrent.Executor

/**
 * 2022-1-15
 * https://github.com/tailoredmedia/BiometricAuth
 * */
...
class PieBiometricAuth(private val context: Context) : BiometricAuth {
    ...
    private fun internalAuthenticate(
        ...
        return Flowable.create<AuthenticationEvent>({ emitter ->
