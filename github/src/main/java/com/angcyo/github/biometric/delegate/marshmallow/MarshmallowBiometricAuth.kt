package com.angcyo.github.biometric.delegate.marshmallow
...
class MarshmallowBiometricAuth(private val activity: FragmentActivity) : BiometricAuth {
    ...
    companion object {
         ...
         */
        private val emitterMap: MutableMap<Int, WeakReference<MaybeEmitter<BiometricAuth.Crypto>>> =
            mutableMapOf()
         ...
         */
        internal fun getEmitter(requestId: Int): MaybeEmitter<BiometricAuth.Crypto>? =
            emitterMap[requestId]?.get()
    ...
    private fun internalAuthenticate(
        ...
        return Maybe.create<BiometricAuth.Crypto> { emitter ->
            ...
            val dialog = MarshmallowFingerprintDialog.create(
                cryptoObject,
                title,
                subtitle,
                description,
