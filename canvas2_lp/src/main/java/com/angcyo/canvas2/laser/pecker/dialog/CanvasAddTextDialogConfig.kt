...
class CanvasAddTextDialogConfig : InputDialogConfig() {
     ...
     * [text] 文本内容
     * [type] 数据类型
     * [com.angcyo.canvas.utils.LPConstant.DATA_TYPE_QRCODE]
     * [com.angcyo.canvas.utils.LPConstant.DATA_TYPE_BARCODE]
     * [com.angcyo.canvas.utils.LPConstant.DATA_TYPE_TEXT]
     * */
    ...
    /**选中的数据类型*/
    var dataType: Int = LPConstant.DATA_TYPE_TEXT
    ...
    override fun initDialogView(dialog: Dialog, dialogViewHolder: DslViewHolder) {
        ...
        dialogViewHolder.tab(R.id.lib_tab_layout)?.apply {
                ...
                if (!reselect) {
                    when (toIndex) {
                        1 -> {
                            ...
                            dataType = LPConstant.DATA_TYPE_QRCODE
                            inputType = InputType.TYPE_CLASS_TEXT
                            digits = null
                        }
                        2 -> {
                            //条形码 BarcodeFormat.CODE_128
                            dataType = LPConstant.DATA_TYPE_BARCODE
                            inputType =
                            ...
                            //文本
                            dataType = LPConstant.DATA_TYPE_TEXT
                            inputType = InputType.TYPE_CLASS_TEXT
                            digits = null
                        }
                    }
            ...
            setCurrentItem(
                when (dataType) {
                    LPConstant.DATA_TYPE_QRCODE -> 1
                    LPConstant.DATA_TYPE_BARCODE -> 2
                    else -> 0
                }
            )
        }
