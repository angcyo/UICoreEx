...
object GenerateTestUserSig {
     ...
     */
    //private const val SECRETKEY = "cd94793fc45d5621027c422f7ff5da14199393fc5843661cad99872e136b13dc"
     ...
     * 文档：https://cloud.tencent.com/document/product/269/32688#Server
     */
    fun genTestUserSig(userId: String, appId: Int, secretKey: String): String {
        return GenTLSSignature(appId.toLong(), userId, EXPIRETIME.toLong(), null, secretKey)
    }
